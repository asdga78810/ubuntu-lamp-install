...
sudo apt-get install nano nginx mariadb-server mariadb-client php-fpm php-mysql php-cli
...
php -r "if (hash_file('SHA384', 'composer-setup.php') === '$HASH') { echo 'Installer verified'; } else { echo 'Ins$
